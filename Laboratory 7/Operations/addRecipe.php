...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    $insertQuery = "INSERT INTO recipe(AuthorID, Name, TypeID, Description) VALUES('$author_id', '$recipe_name', '$type_id', '$description')";


    if($insertResult = mysqli_query($conn, $insertQuery)){
...
<main>
    <form action = "addRecipe.php" method="post" id = "add">
        <div id = "addDiv">
        <label>
